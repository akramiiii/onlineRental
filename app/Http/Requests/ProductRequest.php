...
class ProductRequest extends FormRequest
{
    ...
    public function rules()
    {
        $array =  [
            ...
            'roz' => 'required|numeric'
        ];
        if (!empty($this->request->get('product_number_cart'))) {
            $array['product_number_cart'] = ['numeric' , new CartProductCount($this->request->get('product_number'))];
        }
